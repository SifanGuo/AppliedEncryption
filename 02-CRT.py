...
# test_x = 

# Read lines from input file
input_file_name = "CRTinput.txt"
test_input_file = open(input_file_name, "r")

test_p = int(test_input_file.readline())
test_q = int(test_input_file.readline())
test_g = int(test_input_file.readline())
test_x = int(test_input_file.readline())
...
print("The answer is ", chinese_remainder(test_g, test_p, test_q, test_x))
...
print("The answer is ", Encryption1.fastPower(test_g, test_x, test_p * test_q))
...
# print(test_g ** test_x % (test_p * test_q))
